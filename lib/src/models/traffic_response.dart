...
class TrafficResponse {
  ...
  factory TrafficResponse.fromMap(Map<String, dynamic> json) => TrafficResponse(
        routes: List<Route1>.from(json["routes"].map((x) => Route1.fromMap(x))),
...
class Route1 {
  ...
  factory Route1.fromJson(String str) => Route1.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory Route1.fromMap(Map<String, dynamic> json) => Route1(
