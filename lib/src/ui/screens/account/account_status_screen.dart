...
import 'package:app_cre/src/ui/screens/account/payments/payment_screen.dart';
...
class AccountStatusScreen extends StatefulWidget {
  ...
  const AccountStatusScreen({Key? key, required this.account})
      : super(key: key);
  ...
  void initState() {
    ...
    TokenService().readToken().then((token) {
      UserService().readUserData().then((data) {
        ...
        AccountService()
            .getStatement(token, userData, accountDetail.accountNumber,
          ...
          : SafeArea(
              ...
              child: isOk
                  ? Column(children: [
                      ...
                      doubleRowData("Usuario: ", "Asociado", "Estado: ",
                          accountDetail.state),
                      doubleRowData("Distrito: ", accountDetail.dist,
                          "Sección: ", accountDetail.secc),
                      const CustomDivider(),
                                    ...
                                    children: [
                                      const Text("Facturas impagas: ",
                                          style: TextStyle(
                                              ...
                                              color: Colors.white)),
                                      Text(
                                          accountDetail.numberInvoicesDue
                                              .toString(),
                                          style: const TextStyle(
                                              fontFamily: 'Mulish',
                                              color: Color(0XFF82BA00),
                        ...
                        child: ListView(
                          children: <Widget>[
                            ...
                            (accountDetail.accountType != "Pago Extraordinario")
                                ? itemOption("Historico de Cuenta",
                                    "vuesax-linear-note.png", () {
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) =>
